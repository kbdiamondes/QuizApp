# Generated by Django 4.1.1 on 2022-10-07 01:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='QuizBank',
            fields=[
                ('questionid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='createQuiz.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            name='StudentAnswer',
            fields=[
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='createQuiz.student')),

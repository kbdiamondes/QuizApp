    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quizid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_id', to='createQuiz.quiz')),
                ('student', models.ManyToManyField(to='createQuiz.student')),
            ],
        ),
        migrations.CreateModel(
            name='QuizBank',
        ...
        migrations.AddField(
            model_name='quiz',
            name='student',
            field=models.ManyToManyField(through='createQuiz.StudentAnswer', to='createQuiz.quiz'),
        ),
        migrations.CreateModel(
            name='QuizResult',
            fields=[
        ...
        migrations.AddField(
            model_name='quiz',
            name='teacher',
            field=models.ManyToManyField(to='createQuiz.teacher'),
        ),
    ]
